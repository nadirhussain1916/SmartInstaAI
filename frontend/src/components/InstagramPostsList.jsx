...
const InstagramPostsList = () => {
  const { posts, totalLikes, totalComments } = useSelector((state) => state.posts);
      ...
      <div className="p-6">
        ...
        <div className="mt-6 p-4 bg-white rounded-xl border border-gray-100">
          ...
          <div className="grid grid-cols-2 gap-4 text-center">
            <div>
              <div className="text-lg font-bold text-pink-600">{formatNumber(totalLikes)}</div>
              <div className="text-xs text-gray-600">Total Likes</div>
            </div>
            <div>
              <div className="text-lg font-bold text-blue-600">{formatNumber(totalComments)}</div>
